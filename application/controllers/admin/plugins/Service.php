...
class Service extends Admin_Controller
{
    ...
    public function edit($id = NULL)
    {
        ...
        if($_POST)
        {
            $data = $this->service_m->array_from_post(array('naam', 'titel', 'afbeelding_1', 'titel_1', 'inhoud_1', 'afbeelding_2', 'titel_2', 'inhoud_2', 'afbeelding_3', 'titel_3', 'inhoud_3', 'afbeelding_4', 'titel_4', 'inhoud_4', 'link_1', 'link_2', 'link_3', 'link_4'));
    ...
    public function delete($id)
    {
        ...
        redirect('admin/plugins/service/index/');
    }
}