        ...
        <div class="col-lg-7">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo empty($banner->id) ? 'Toevoegen' : 'Beerken ' . $banner->naam; ?></h5>
                ...
                <div class="ibox-content">
                    ...
                    echo form_open('', $attributes); ?>
                        ...
                        <div class="form-group ">
                            <label class="col-md-2 control-label" for="bannername">Naam:</label>
                            <div class="col-md-10">
                                <?php echo form_input('naam', set_value('naam', $banner->naam)); ?>
                            </div>
                        </div> <!-- formrow -->
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-10">
                                <?php echo form_input('titel_nl', set_value('titel_nl', $banner->titel_nl)); ?>
                            </div>
                        </div> <!-- formrow -->
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-10">
                                <div class="input-group m-b">
                                    ...
                                    <?php echo form_input('afbeelding', set_value('afbeelding', $banner->afbeelding)); ?>
                                </div>
                            </div>
                        </div> <!-- formrow -->
