            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-10">
                            <?php echo form_dropdown('template', array('page' =>'Pagina met inhoud', 'gerechten' => 'Gerechten', 'dranken'=> 'Dranken', 'contact' => 'Contact'), $this->input->post('template') ? $this->input_post('template') : $page->template, 'class="select_2"'); ?>
